...
#include "../../TCPServerNew/mytcpserver.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTcpServerENDCLASS_t qt_meta_stringdata_CLASSMyTcpServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 16),  // "signal_to_thread"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "MyTcpServer",
    "signal_to_thread",
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_to_thread(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MyTcpServer::signal_to_thread; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpServer::signal_to_thread()
{
